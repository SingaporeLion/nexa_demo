...
import 'package:nexa/data/controller/plan/buy_plan/buy_plan_controller.dart';
...
import 'package:nexa/views/components/text-field/outlined_text_field.dart';
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const CustomDivider(space: Dimensions.space15),
                        buyPlanController.purchaseLoading
                            ...
                            : RoundedButton(
                                ...
                                press: () {
                                  ...
                                  buyPlanController.planPurchase(
                                      ...
                                      paymentMethod: buyPlanController.selectPaymentSystem == MyStrings.fromBalance
                                          ? '1'
                                          : buyPlanController.selectPaymentSystem == MyStrings.directPayment
                                              ? '2'
                                              : '0');
                                })
                      ],
