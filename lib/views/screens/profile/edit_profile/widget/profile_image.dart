...
import 'package:nexa/views/components/buttons/circle_image_button.dart';
import 'package:nexa/views/screens/auth/profile_complete/widget/build_circle_widget.dart';
...
class _ProfileWidgetState extends State<ProfileWidget> {
  ...
  Widget buildImage() {
    ...
    if (imageFile != null) {
      ...
      image = const AssetImage(MyImages.person);
    }
