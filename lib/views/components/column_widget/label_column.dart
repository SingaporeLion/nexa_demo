  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(body.tr,style: lastTextRed?interRegularDefault.copyWith(fontFamily:"Inter",fontSize:isSmallFont?Dimensions.fontSmall:Dimensions.fontDefault,color: MyColor.redCancelTextColor):interRegularDefault.copyWith(fontFamily:"Inter",color: MyColor.colorBlack,fontSize:isSmallFont?Dimensions.fontSmall:Dimensions.fontDefault,),overflow: TextOverflow.ellipsis,)
      ],
    );
  }
}
