        ...
        widget.isUnderLined?SizedBox(
          ...
          child: DropdownButtonFormField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: interRegularDefault.copyWith(color: MyColor.colorBlack),
              contentPadding: const EdgeInsets.symmetric(vertical: 15, horizontal: 0),
              border: const UnderlineInputBorder(borderSide: BorderSide(color: MyColor.textFieldBorderColor,width: .5)),
              focusedBorder: const UnderlineInputBorder(borderSide: BorderSide(color: MyColor.primaryColor,width: .5)),
              enabledBorder: const UnderlineInputBorder(borderSide: BorderSide(color: MyColor.textFieldBorderColor,width: .5)),
            ),
            isExpanded: true,
          ...
          child: DropdownButtonFormField(
            ...
            decoration: InputDecoration(
              ...
              border: OutlineInputBorder(
                ...
                borderSide: const BorderSide(color: MyColor.colorGrey, width: .5),
              ),
